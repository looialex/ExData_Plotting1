...
# and creates a 2 x 2 plots: Global Active Power, Voltage, Energy sub metering,
# Global_reactive_power in PNG.
...
png(filename = "plot4.png", width = 480, height = 480) # config graphic device for PNG
par(mfrow = c(2,2)) # create a 2 by 2 plot

# Plotting first graph
plot(final_data$Date_Time, final_data$Global_active_power, type = "n",
     xlab = "", ylab = "Global Active Power")
lines(final_data$Date_Time, final_data$Global_active_power,col = "BLACK")

# Plotting second graph
plot(final_data$Date_Time, final_data$Voltage, type = "n",
     xlab = "datetime", ylab = "Voltage")
lines(final_data$Date_Time, final_data$Voltage,col = "BLACK")
...
plot(final_data$Date_Time, final_data$Global_reactive_power, type = "n",
     xlab = "datetime", ylab = "Global_reactive_power")
lines(final_data$Date_Time, final_data$Global_reactive_power, col = "BLACK")

dev.off() # turn off graphics device
print("PNG Data Plotted to /Data/plot4.png")
