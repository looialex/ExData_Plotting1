...
# and creates a Global Active Power line plot and print it to PNG
...
png(filename = "plot2.png", width = 480, height = 480) # config graphic device for PNG
plot(final_data$Date_Time, final_data$Global_active_power, type = "n",
     xlab = "", ylab = "Global Active Power (Kilowatts)")
lines(final_data$Date_Time, final_data$Global_active_power)
dev.off() # turn off graphics device
print("PNG Data Plotted to /Data/plot2.png")
